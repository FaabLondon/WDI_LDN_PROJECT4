...
class BrandProductSearch extends React.Component{
        ...
        <form>
          <div className="field SearchByControl">
            <p className="control has-icons-left">
              <input className="searchField input" type="text" name="query" placeholder="Search by brand or product description" onChange={this.props.handleSearch} />
